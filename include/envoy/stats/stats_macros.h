...
#define GENERATE_FAST_COUNTER_STRUCT(NAME) Stats::Counter& NAME##_;
...
#define POOL_FAST_COUNTER_PREFIX(POOL, PREFIX) (POOL).fastFindCounter(PREFIX FINISH_STAT_DECL_
...
#define POOL_FAST_COUNTER(POOL) POOL_FAST_COUNTER_PREFIX(POOL, "")
