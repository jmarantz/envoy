...
class CacheIntegrationTest : public HttpIntegrationTest,
...
public:
  ...
  */
  ...
  const std::string default_config{"name: envoy.cache"};
...
/**
 * Exercises cache compression with default configuration.
 */
 ...
 */
TEST_P(CacheIntegrationTest, IdentityAcceptEncoding) {
  initializeFilter(default_config);
 ...
 */
TEST_P(CacheIntegrationTest, NotSupportedAcceptEncoding) {
  initializeFilter(default_config);
  doRequestAndNoCompression(Http::TestHeaderMapImpl{{":method", "GET"},
                                                    {":path", "/test/long/url"},
                                                    {":scheme", "http"},
 ...
 */
TEST_P(CacheIntegrationTest, UpstreamResponseAlreadyEncoded) {
  initializeFilter(default_config);
 ...
 */
TEST_P(CacheIntegrationTest, NotEnoughContentLength) {
  initializeFilter(default_config);
  Http::TestHeaderMapImpl request_headers{{":method", "GET"},
                                          {":path", "/test/long/url"},
                                          {":scheme", "http"},
 ...
 */
TEST_P(CacheIntegrationTest, EmptyResponse) {
  initializeFilter(default_config);
  Http::TestHeaderMapImpl request_headers{{":method", "GET"},
                                          {":path", "/test/long/url"},
                                          {":scheme", "http"},
 ...
 */
TEST_P(CacheIntegrationTest, SkipOnContentType) {
  initializeFilter(full_config);
  doRequestAndNoCompression(Http::TestHeaderMapImpl{{":method", "GET"},
                                                    {":path", "/test/long/url"},
                                                    {":scheme", "http"},
 ...
 */
TEST_P(CacheIntegrationTest, SkipOnCacheControl) {
  initializeFilter(full_config);
  doRequestAndNoCompression(Http::TestHeaderMapImpl{{":method", "GET"},
                                                    {":path", "/test/long/url"},
                                                    {":scheme", "http"},
...
/**
 * Exercises cache compression when upstream returns a chunked response.
 */
TEST_P(CacheIntegrationTest, AcceptanceFullConfigChunkedResponse) {
  initializeFilter(full_config);
  Http::TestHeaderMapImpl request_headers{{":method", "GET"},
                                          {":path", "/test/long/url"},
                                          {":scheme", "http"},
 ...
 */
TEST_P(CacheIntegrationTest, AcceptanceFullConfigVeryHeader) {
  initializeFilter(default_config);
  Http::TestHeaderMapImpl request_headers{{":method", "GET"},
                                          {":path", "/test/long/url"},
                                          {":scheme", "http"},
